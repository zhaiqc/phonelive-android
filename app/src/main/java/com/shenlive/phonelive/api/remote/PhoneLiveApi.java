...
public class PhoneLiveApi {
     ...
     * 获取分类列表
     */
    public static void getDirectory(StringCallback callback) {
        OkHttpUtils.get()
                .url(AppConfig.MAIN_URL_API)
                .addParams("service", "Home.directory")
                .build()
                .execute(callback);
    }
     ...
     * 设置主播分类
     */
    public static void setDirectory(String id, String uid, StringCallback callback) {
        OkHttpUtils.get()
                .url(AppConfig.MAIN_URL_API)
                .addParams("service", "Home.update")
                .addParams("id", id)
                .addParams("uid", uid)
                .build()
                .execute(callback);
    ...
    public static void otherRoomData( String id,StringCallback callback) {
        OkHttpUtils.get()
                .url(AppConfig.MAIN_URL_API)
                .addParams("service", "Home.dir")
                .addParams("id", id)
                .build()
                .execute(callback);
    }
